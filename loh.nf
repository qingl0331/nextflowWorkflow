...
process tMpileup {
    ...
    """
    samtools mpileup -B -q 1 -d 1000000 -f /uufs/chpc.utah.edu/common/home/hcibcore/atlatl/data/Human/Hg38/hg38.fa -l /uufs/chpc.utah.edu/common/home/u0762203/db/mergedSeqCap_EZ_Exome_v3_hg38_capture_primary_targets_pad150bp.bed.gz ${params.bam} > ${id}.bam.mpileup
    bgzip ${id}.bam.mpileup
    tabix -s 1 -b 2 -e 2 ${id}.bam.mpileup.gz
    """
}
...
process cleanVcf {
    ...
    """
    gunzip -c ${params.vcf} > ${id}.g.vcf
    /uufs/chpc.utah.edu/common/home/u0762203/bin/cleanVcf.pl ${id}.g.vcf
    """
}
...
process vt {
    ...
    """
    /uufs/chpc.utah.edu/common/home/u0762203/app/vt/vt normalize ${id}.NormalDNA.clean.vcf -r /uufs/chpc.utah.edu/common/home/hcibcore/atlatl/data/Human/Hg38/hg38.fa -o norm.${id}.NormalDNA.clean.vcf -n
   /uufs/chpc.utah.edu/common/home/u0762203/app/vt/vt decompose_blocksub norm.${id}.NormalDNA.clean.vcf -o block.norm.${id}.NormalDNA.clean.vcf
    """
}
/*
...
process anot {
    ...
    """
    java -jar /uufs/chpc.utah.edu/common/home/u0762203/USeq_9.2.4/Apps/VCFMpileupAnnotator -v block.norm.${id}.NormalDNA.clean.vcf -q 13 -m ${id}.bam.mpileup.gz -o ${id}.TumorDNA_Hg38_final.vcf.gz
...
process calcuAf {
    ...
    script:
    """
    /uufs/chpc.utah.edu/common/home/u0762203/bin/calcuAf.pl block.norm.${id}.NormalDNA.clean.vcf ${id}.TumorDNA_Hg38_final.vcf ${id}
    """
}
...
process loh {
    ...
    """
     #path=`echo \$PWD`
    /uufs/chpc.utah.edu/common/home/u0762203/bin/loh.R ${id}.normal.het.baf.txt ${id}.tumor.ave.baf.txt ${id} 
    """
}
...
process anotRf {
    ...
    """
    java -jar /uufs/chpc.utah.edu/common/home/u0762203/USeq_9.2.4/Apps/AnnotateBedWithGenes -p 100 -g -b ${id}.loh.bed -r ${id}.targetWithGenes.txt.gz -u /uufs/chpc.utah.edu/common/home/u0762203/annotation/hg38RefSeq8Aug2018_Merged.ucsc.gz
    gunzip ${id}.targetWithGenes.txt.gz
    /uufs/chpc.utah.edu/common/home/u0762203/bin/rf4lohImport.pl ${id}.targetWithGenes.txt
    """
}
