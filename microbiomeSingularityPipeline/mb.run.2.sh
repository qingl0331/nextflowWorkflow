...
SINGULARITYENV_jobDir=$jobDir  SINGULARITYENV_g38Dir=$g38Dir SINGULARITYENV_runDir=$runDir SINGULARITYENV_hn2pdb=$hn2pdb SINGULARITYENV_hn2ndb=$hn2ndb SINGULARITYENV_srRnaDb=$srRnaDb SINGULARITYENV_container=$container $singExec exec --containall --bind $g38Dir $container bash $runDir/mb.2.sing
