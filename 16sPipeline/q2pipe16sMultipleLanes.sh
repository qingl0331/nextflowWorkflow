...
ResultDir=/uufs/chpc.utah.edu/common/home/u0762203/u0762203/project/neli/microbiome/16SrRNA/15215Rtest/q2.result
...
--p-mode sum \
--o-grouped-table table_bySamp.qza

singularity exec ${ContainerImage} qiime feature-table summarize \
--i-table table_bySamp.qza \
--o-visualization table_bySamp.qzv \
...
cp table_bySamp.qza ${ResultDir}/; cp table_bySeqID.qza ${ResultDir}/
